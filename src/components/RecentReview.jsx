    ...
    return (
        <div>
            <section className="my-10 text-center">
                <h2 className="text-3xl font-poppins font-bold">Recent Review</h2>
            </section>
            <div className="flex gap-5 flex-col md:flex-row lg:flex-row">
                ...
                <div className="container flex flex-col w-full max-w-lg p-6 mx-auto divide-y rounded-md bg-blue-300 ">
