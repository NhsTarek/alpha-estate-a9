...
const SocialLogin = () => {
    ...
    return (
        <div>
            ...
            <div className="flex border-2 my-5 rounded-2xl gap-10  items-center btn justify-center" onClick={() => googleLogin()}>
                <span className="text-3xl text-red-600"><FaGoogle /></span>
                <h2 className="text-2xl font-poppins font-semibold">Login With Google</h2>
            </div>
            <div className="flex border-2 rounded-2xl gap-5 md:gap-10 lg:gap-10  items-center btn justify-center" onClick={() => githubLogin()}>
